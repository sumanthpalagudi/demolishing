...
def send_message_to_gpt3(user_input):
    ...
    response = openai.chat.completions.create(   
        ...
        messages=[{"role":"system","content":"you are expert in git,based on what they ask you have give them with commands that they should run on command line"},  # The chat history between User and GPT-3.5
